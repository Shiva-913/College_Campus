    ...
    <body>
        <div class="container">
            <div class="box" style="overflow: auto;">
                <a style="margin-left:250px;color:red;" href="../../HomePage/reviewer/reviewer.php">Home</a>
                <div style="text-align: center;word-break: break-all;white-space: normal;"><?php echo '(REVIEWER)'.$_SESSION['username']; ?></div>
                <div id="search-form_3" style="width:280px;height:37px;margin-top: 10px;margin-bottom:20px;">
                    <input type="text" id="search_3" autocomplete="off" style="text-align: center;width:165px;height:21px;border-color:black;border-radius: 20px;margin-top: 3px;margin-left:5px;border-color:black;border:10px;font-size:12px;" placeholder="Enter here..."/>
                ...
                <?php
                 ...
                 $con= connect();
                 $res= mysqli_query($con,"select * from detail where type='USER'");
