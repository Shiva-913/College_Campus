...
outline:0;
    ...
    <body>
        <div id="container1" style="background-color:lightblue;">
            <div id="menu1">
                <font face="Segoe UI" size="5">FAQ_BE</font>
                <a class="a" style="margin-left:620px;font-size:15px;font-family:Segoe UI;font-weight: normal;" href="../../HomePage/user/user.php">Home</a>
            </div>
            <center>
             <br>
                ...
                $con=connect();
                $res=mysqli_query($con,"select * from faq where type='BE' order by id desc");
