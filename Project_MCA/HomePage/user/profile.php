...
<html>
    ...
    <body><form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype='multipart/form-data'>
        <div id="container" style="background-color:lightblue;width:450px;">
            <div id="menu">
                <font face="Segoe UI" size="5">Profile_Page(USER)</font>
                <a class="a" style="margin-left:180px;font-size:15px;font-family:Segoe UI;font-weight: normal;" href="../../HomePage/user/user.php">Home</a>
            </div>
            <center>
        ...
        <br>
      <center>
        <input type="text" class="text" name="txtname" style="margin-top:20px;"  autocomplete="off" required value="<?php echo $res['name'];?>">
        <input type="text" class="text" name="txtemail" style="margin-top:20px;" autocomplete="off" required value="<?php echo $re['email'];?>">
        <input type="text" class="text" name="txtpass" style="margin-top:20px;" autocomplete="off" required placeholder="Enter your Password">
        <input type="text" class="text" name="txtcpass" style="margin-top:20px;" autocomplete="off" required placeholder="Enter your Confirm Password"><br><br><br>
