    ...
    <body>
        <div class="hero-bkg-animated" id="container">
            <div class="topnav" style="opacity: 0.7;">
                <a class='active' href='../reviewer/profile.php?load=UPDATE'>Profile</a>
                <a href="../../Chat/User/chat_user.php">Chat</a>
                <div class="dropdown">
                    <button class="dropbtn">Questions
                        <i class="fa fa-caret-down"></i>
                    </button>
                    <div class="dropdown-content">
                        <a href="../reviewer/Question.php">Answered by me</a>
                        <a href="../reviewer/Q&A.php">To be answered</a>
                    </div>
                </div>
